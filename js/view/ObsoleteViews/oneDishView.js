...
var OneDishView = function (container, model) {
	...
	*/
	...
	this.dishSpecific.append("<div class='dishItem'>"+
		...
		"<a href='select_dish.html' class='btn'>back to Select dish</a></div>");

	var sum = 0;

	for(i = 0; i < dish.ingredients.length; i++ ) {
		sum += dish.ingredients[i].price
		this.ingredients.append("<div class='col-md-4'>"+dish.ingredients[i].quantity+""+dish.ingredients[i].unit+"</div>"+
